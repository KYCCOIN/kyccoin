...
#   c) node1 mines 32 blocks, so now node 0 has 60001kyccoin, node 1 has 4250kyccoin, node2 has none.
#   d) node0 sends 601 kyccoin to node2, in two transactions (301 kyccoin, then 300 kyccoin).
