...
RESOURCES += src/qt/kyccoin.qrc src/qt/kyccoin_locale.qrc

TRANSLATIONS += src/qt/locale/kyccoin_bg.ts \
                src/qt/locale/kyccoin_de.ts \
                src/qt/locale/kyccoin_en.ts \
                src/qt/locale/kyccoin_es.ts \
                src/qt/locale/kyccoin_fi.ts \
                src/qt/locale/kyccoin_fr.ts \
                src/qt/locale/kyccoin_it.ts \
                src/qt/locale/kyccoin_ja.ts \
                src/qt/locale/kyccoin_pl.ts \
                src/qt/locale/kyccoin_pt.ts \
                src/qt/locale/kyccoin_ru.ts \
                src/qt/locale/kyccoin_sk.ts \
                src/qt/locale/kyccoin_sv.ts \
                src/qt/locale/kyccoin_vi.ts \
                src/qt/locale/kyccoin_zh_CN.ts \
                src/qt/locale/kyccoin_zh_TW.ts
