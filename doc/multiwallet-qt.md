...
In order to support loading of multiple wallets in kyccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kyccoin.cpp.
...
Changes to kyccoin.cpp
----------------------
kyccoin.cpp is the entry point into kyccoin-qt, and as such, will require some minor modifications to provide hooks for
