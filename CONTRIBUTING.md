Contributing to kyccoin Core
============================

The kyccoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the kyccoin Core project, and is not to be
confused with overall kyccoin Network Protocol consensus changes.

Whether a pull request is merged into kyccoin Core rests with the project merge
...
Patches that change kyccoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the kyccoin consensus, it must have been
...
The project leader is the release manager for each kyccoin Core release.
