...
{
public:
    /// Is the inputs associated with this public key? (and there is 6000 kyccoin- checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of kyccoin.
