...
#ifndef kyccoin_ZkyccoinWALLET_H
#define kyccoin_ZkyccoinWALLET_H
...
public:
    CzkyccoinWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZkyccoin(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZkyccoin(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //kyccoin_ZkyccoinWALLET_H
