...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("kyccoin Core kyccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kyccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kyccoin transaction") + "\n" +
                               "  kyccoin-tx [options] -create [commands]   " + _("Create hex-encoded kyccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kyccoin transaction
