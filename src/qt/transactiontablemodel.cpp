...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("kyccoin Stake");
    case TransactionRecord::StakeZkyccoin:
        return tr("zkyccoin Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted kyccoin to zkyccoin");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zkyccoin");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received kyccoin from zkyccoin");
    case TransactionRecord::ZerocoinSpend_Change_zkyccoin:
        return tr("Minted Change as zkyccoin from zkyccoin Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zkyccoin to kyccoin");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zkyccoin:
        return tr("Anonymous (zkyccoin Transaction)");
    case TransactionRecord::StakeZkyccoin:
        return tr("Anonymous (zkyccoin Stake)");
    case TransactionRecord::SendToSelf:
    default:
