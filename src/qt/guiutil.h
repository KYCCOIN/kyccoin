...
/** Utility functions used by the kyccoin Qt UI.
 */
namespace GUIUtil
{
...
// Render kyccoin addresses in monospace font
...
// Parse "kyccoin:" URI into recipient object, return true on successful parsing
