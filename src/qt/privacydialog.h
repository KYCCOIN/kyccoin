...
public:
    ...
    void setZkyccoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzkyccoin_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzkyccoin_clicked();
    void on_pushButtonZkyccoinControl_clicked();
