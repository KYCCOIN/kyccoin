                                                    ...
                                                    transactionView(0)
{
    ...
    */
    ...
    /*
	typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZkyccoin));
    */
	typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    /*
	typeWidget->addItem(tr("Received kyccoin from zkyccoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zkyccoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zkyccoin));
