...
// Copyright (c) 2015-2018 The kyccoin developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzkyccoinPathCustom = GetArg("-zkyccoinbackuppath", "");
    ...
    if(!strzkyccoinPathCustom.empty()) {
        ui->wallet_customzkyccoinbackuppath->setText(QString::fromStdString(strzkyccoinPathCustom));
        ui->wallet_customzkyccoinbackuppath_label->setVisible(true);
        ui->wallet_customzkyccoinbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzkyccoinPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the kyccoin RPC console.") + "<br>" +
