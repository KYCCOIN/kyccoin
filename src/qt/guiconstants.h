...
/* kyccoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "kyccoin"
#define QAPP_ORG_DOMAIN "kyccoin.org"
#define QAPP_APP_NAME_DEFAULT "kyccoin-Qt"
#define QAPP_APP_NAME_TESTNET "kyccoin-Qt-testnet"
