...
#ifndef kyccoin_ZkyccoinTRACKER_H
#define kyccoin_ZkyccoinTRACKER_H
...
public:
    CzkyccoinTracker(std::string strWalletFile);
    ~CzkyccoinTracker();
...
#endif //kyccoin_ZkyccoinTRACKER_H
