...
public:
    ...
    bool WriteZkyccoinSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZkyccoinSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZkyccoinSeed_deprecated(uint256& seed);
    bool EraseZkyccoinSeed();
    bool EraseZkyccoinSeed_deprecated();

    bool WriteZkyccoinCount(const uint32_t& nCount);
    bool ReadZkyccoinCount(uint32_t& nCount);
